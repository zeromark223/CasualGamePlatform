...
exports.SendMasterCommandCPP = function (data) {
    Publish(Config.Channel.MasterGMCPP, JSON.stringify(data));
};
exports.SendGameCommand = function (data) {
//    data.SID = MasterID; bo de kick game
...
function InitChannelSubcribe() {
    Subcribe(Config.Channel.MasterGM);
