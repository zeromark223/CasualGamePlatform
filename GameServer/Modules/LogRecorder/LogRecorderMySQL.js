...
exports.listUserFishRecord = function (UserID, KindID, MatchID, FishKind, FishCount, BulletCount, UserPayMoney, UserEarnMoney, UpdateTime, ChannelID) {
...
exports.hitBossLogging = function (UserID, BossID, TotalHit, AwardMoney, LastHitAward, LastHitTime, CreateTime, KindID, ServerID) {
    var tableName = 'globalboss_userhit_log';
    try {
        insertTable(tableName + Utility.GenSuffixDateSql(),
            [
                "UserID",
