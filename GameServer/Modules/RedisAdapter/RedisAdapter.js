...
exports.GlobalBossRecordUserLastHit = function (FishID, UserID, LastHitTime) {
    try {
        client.zadd(Config.Define.GlobalBossListUser + FishID, LastHitTime, UserID);
        client.expire(Config.Define.GlobalBossListUser + FishID, 2592000)//1 tháng 30*60*3600
    } catch (e) {
...
exports.zRange = function (zkey, start, end, callback) {
    try {
        client.zrange(zkey, start, end, function (e, d) {
            callback(e, d);
        });
    } catch (e) {
        loggerRedis.error('RedisAdapter - zRange - try err: ' + e.stack);
    }
};