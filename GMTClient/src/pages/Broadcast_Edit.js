...
class Broadcast_Edit extends Component {
    constructor(props) {
        super(props);
        ...
        this.TempTime = {
            StartTime: RedirectData.StartTime,
            EndTime: RedirectData.EndTime
        };

        RedirectData.StartTime = new Date(RedirectData.StartTime);
        RedirectData.EndTime = new Date(RedirectData.EndTime);
        ...
        return (
            <div>
                <div className="layout">
                    <h1 id="dataTitle">Update Broadcast: </h1>
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="col-sm-6">
                                        <input id="ID" className="form-control"
                                               value={this.state.RedirectData.ID}
