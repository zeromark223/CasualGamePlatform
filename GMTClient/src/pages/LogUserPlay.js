...
class LogUserPlay extends Component {
    constructor(props) {
        super(props);
    ...
    OnUpdateState(Data) {
        ...
        var Result = Data.LogUserPlayArray;
    ...
    render() {
        ...
        var LoginLogTable = this.RenderLoginLog();

        return (

            <div>
                <div className="layout">
                    <h1><Label>Log User Play: </Label></h1>
                    ...
                    <div className="box-body table-striped">
                        <Table striped bordered condensed hover>
                            ...
                            <tbody>
                            {
                                this.state.Data.LogUserPlayArray.map(function (UserData, index) {
                                    return <tr key={index}>
                                        <td>{UserData.Id}</td>
                                        ...
                                        <td>{UserData.KindID}</td>
                                        <td>{this.FormatNumber(UserData.MoneyIn)}</td>
                                        <td>{this.FormatNumber(UserData.MoneyChange)}</td>
                                        <td>{this.FormatNumber(UserData.MoneyOut)}</td>
                                        <td>{UserData.TimeIn}</td>
                                        <td>{UserData.TimeOut}</td>
    ...
    RenderLoginLog(){
        return <div className="box-body table-striped">
            <Table striped bordered condensed hover>
                <thead>
                <tr>
                    <th>UserID</th>
                ...
                <tbody>
                {
                    this.state.Data.LoginLogArray.map(function (UserData, index) {
                        return <tr key={index}>
                            <td>{UserData.UserID}</td>
                            <td>{UserData.Nick}</td>
                            <td>{UserData.IP}</td>
