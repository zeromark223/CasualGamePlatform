...
class XocDia_Info extends Component {
    constructor(props) {
        super(props);
        ...
        this.BetKindList = [
            ...
            {
                BetKind: 3,
                BetName: "0 Đỏ - 4 Trắng"
            },
            {
                BetKind: 4,
                BetName: "1 Đỏ - 3 Trắng"
            },
            {
                BetKind: 5,
                BetName: "3 Đỏ - 1 Trắng"
            },
            {
                BetKind: 6,
                BetName: "4 Đỏ - 0 Trắng"
            },
        ];
    ...
    GetBetNameByKind(KindID){
        var Name = '' + KindID;

        for(var i = 0; i < this.BetKindList.length; i++){
            if(this.BetKindList[i].BetKind == KindID){
                Name = this.BetKindList[i].BetName;
                break;
            }
        }
                    ...
                    <tbody>
                    {
                        this.state.Data.BetLogWithWin.map(function (Element, index) {
                            if (index >= ResultFrom && index < ResultTo) {
                                var Name = this.GetBetNameByKind(Element.BetID);
                                return <tr key={index}>
                                    <td>{index + 1}</td>
    ...
    render() {
        ...
        return (
            <div>
                <div>
                    <h1><Label>Thông tin Xóc Dĩa: </Label></h1>
                    {RequestTable}
                    <br></br>
                    <br></br>
                    {RenderBetLog}
