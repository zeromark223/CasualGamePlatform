...
exports.zAdd = function (zkey, keyScore, keyValue) {
    try {
        if (Utility.CheckVariable(zkey) && Utility.CheckVariable(keyScore) && Utility.CheckVariable(keyValue)) {
            client.zadd(zkey, keyScore, keyValue);
        } else {
            loggerRedis.error('RedisAdapter - zAdd Param error ', zkey, keyScore, keyValue);
        }
...
exports.incrBy = function (key, value) {
    try {
        client.incrby(key, value);
    }
    catch (e) {
        loggerRedis.error('RedisAdapter - incry - try err: ', key, value, e.stack);
    }
};
...
exports.getAndSet = function (key, newVal, callback) {
    try {
