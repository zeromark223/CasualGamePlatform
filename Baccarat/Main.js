...
MainCore.prototype.ReloadBetLimitConfig = function () {
    try {
        ...
        var BetLimitConfig = requireUnCached('../Config/Baccarat/BetLimitConfig.js');//Ko gan truc t iep, tranh loi
...
MainCore.prototype.LogUserBet_Insert = function (User, ID, Gold, MatchID, Tax, ChannelID) { // Log tam
    try {
        this.LogRecorder.logUserBet(User.UserID, ID, Gold, MatchID, Tax, ChannelID)
    } catch (e) {
