...
var StartMatchResponse = { //2007 //bắt đầu nhận cược
    ...
    NumberOfCards: Define.UInt16
};

var EndMatchResultResponse = { //2008
    PlayerCard: Define.Object8,
    PlayerCard_Struct:{
        Score: Define.UInt8,
        Suit: Define.UInt8
    },

    BankerCard: Define.Object8,
    BankerCard_Struct:{
        Score: Define.UInt8,
        Suit: Define.UInt8
    },
...
var MatchHistoryResponse = { //2010
    Result: Define.Object8, // Kết quả tổng
    Result_Struct:{
        PlayerScore: Define.UInt8,
        BankerScore: Define.UInt8,
        PlayerPair: Define.UInt8,
        BankerPair: Define.UInt8
    }
};
